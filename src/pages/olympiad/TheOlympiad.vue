          ...
          <section>
            ...
            <ul class="steps">
              <li>Зареєструватися для участі в першому дистанційному турі олімпіади шляхом заповнення і відправки форми,
                яка опублікована на даній сторінці, в період з 01 по 25 березня 2019 року.
              </li>
              ...
              <li>Отримати запрошення на другий очний тур Олімпіади, який буде проходити 20 квітня 2019 року.</li>
              <li>Прибути до університету об 11-00 20 квітня 2019 року, виконати завдання Олімпіади і отримати додаткові бали
