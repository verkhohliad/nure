<template>
  <div class="container">
    <v-layout row wrap class="olympiad-content">
      <v-flex d-flex xs12 sm12 md12 child-flex>
          <section>
            <h2>Реєстрація на участь в олімпіаді ХНУРЕ буде доступна з 1 березня.</h2>
              <p>
                Харківський національний університет радіоелектроніки проводить
                Всеукраїнську олімпіаду  навчального закладу для абітурієнтів на основі повної середньої освіти з предметів:
              </p>
              <ul class="steps">
            ...
            <ul class="steps">
                ...
                <li>Прибути до університету об 11-00   22 квітня 2018 року,  виконати завдання Олімпіади і отримати
                  додаткові бали до сертифікату ЗНО з певного предмету при вступі до ХНУРЕ.</li>
